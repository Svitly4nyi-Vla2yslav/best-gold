...
const goldIcon = new L.Icon({
    iconUrl: 'https://png.pngtree.com/png-vector/20220108/ourmid/pngtree-three-dimensional-metal-texture-gold-coin-icon-png-image_4122362.png', // Замініть на URL вашої іконки
    iconSize: [30, 30],
  });
